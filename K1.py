...
tk.Label(frame_data, text="Muhammad Nur Faiz", font=("Arial", 12, "bold")).grid(row=0, column=2, sticky="w", padx=10)
...
tk.Label(frame_data, text="L200250202", font=("Arial", 12, "bold")).grid(row=1, column=2, sticky="w", padx=10)
...
tk.Label(frame_data, text="Maling Kundang", font=("Arial", 12, "bold")).grid(row=2, column=2, sticky="w", padx=10)
...
tk.Label(frame_data, text="Pantang nyerah sebelum error ditemukan", font=("Arial", 12, "bold")).grid(row=3, column=2, sticky="w", padx=10)
